"use client"; // you can remove this line since it’s React, not Next.js
    ...
    <div className={darkMode ? "bg-[#00155B] text-white min-h-screen" : "bg-white text-gray-900 min-h-screen"}>
      ...
      <header className="flex justify-between items-center px-8 py-4 border-b border-gray-400 dark:border-gray-300">
        ...
        <nav className="flex items-center gap-6">
          ...
          <a href="#" className="text-[16px] hover:underline">Docs</a>
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 gap-8 px-12 py-16 items-center">
        {/* Left */}
        <div>
          <h1 className="text-[35px] font-bold mb-6">Reactive Cursors</h1>
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-[28px] font-semibold mb-2">About Us</h2>
          ...
          <section>
            <h3 className="text-[24px] font-semibold mb-2">Installation</h3>
            <pre className="bg-gray-100 dark:bg-slate-800 p-3 rounded-lg text-[14px]">
              npm install reactive-cursors
            </pre>
          </section>

          <section>
            <h4 className="text-[20px] font-semibold mb-2">Cursor Preview</h4>
