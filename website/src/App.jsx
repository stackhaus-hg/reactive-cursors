  ...
  return (
    <Fragment>
      {/* New Routing Setup using the Layout component  */}
        {/* Page routing */}
        <Routes>          
          <Route path="/" element={<Layout />} >  {/* Note how the Layout component is used as an element instead of a wrapper */}
            {/* Remaining routes are nested (and so are children of the Layout route as well as also inheriting the path of the parent) */}
            <Route index element={ <Stackhaus /> } />  {/* Use index rather than path='/' */}
